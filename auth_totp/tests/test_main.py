...
class TestAuthTotp(TransactionCase):
    ...
    def test_mfa_login_form(self, request_mock):
        '''Should render mfa_login template with correct context'''
        request_mock.reset_mock()
        self.test_controller.mfa_login_form()
    ...
    def test_mfa_login_invalid_token(self, request_mock):
        ...
        test_result = self.test_controller.mfa_login()
    ...
    def test_mfa_login_expired_token(self, request_mock):
    ...
    def test_mfa_login_invalid_conf_code(self, request_mock):
    ...
    def test_mfa_login_valid_new_token(self, val_mock, gen_mock, request_mock):
        ...
        gen_mock.reset_mock()
        self.test_controller.mfa_login()

        gen_mock.assert_called_once_with(60 * 24 * 30)

    @mock.patch(ENVIRONMENT_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_valid_session(self, val_mock, env_mock, request_mock):
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_valid_redirect(self, val_mock, gen_mock, request_mock):
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_valid_redir_def(self, val_mock, gen_mock, request_mock):
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_cookie_device(self, val_mock, gen_mock, request_mock):
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_cookie_werkzeug_cookie(
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_cookie_werkzeug_cookie_exp(
        ...
        val_mock.return_value = True
        dt_mock.now.return_value = datetime(2016, 12, 1)
        json_mock.reset_mock()
        self.test_controller.mfa_login()
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_cookie_final_cookie(
        self, val_mock, gen_mock, json_mock, resp_mock, dt_mock, request_mock
    ):
    ...
    @mock.patch(GENERATE_PATH)
    @mock.patch(VALIDATE_PATH)
    def test_mfa_login_cookie_final_cookie_secure(
