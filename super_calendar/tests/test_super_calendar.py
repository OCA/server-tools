...
class TestSuperCalendar(TransactionCase):
    ...
    def test_get_record_values_from_line(self):
        ...
        values_partner_a = {
            'configurator_id': self.super_calendar_configurator.id,
            'date_start': fields.Datetime.to_string(self.partner_A.write_date),
            'duration': False,
        ...
        start_date = fields.Datetime.to_datetime(self.partner_A.write_date.replace(microsecond=0))
        stop_date = fields.Datetime.to_datetime(self.partner_A.date)
    ...
    def test_generate_calendar_records(self):
        ...
        self.assertEqual(
            ...
            fields.Datetime.to_datetime(self.partner_A.write_date.replace(microsecond=0))
        )
