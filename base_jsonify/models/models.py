...
class Base(models.AbstractModel):
    ...
    @api.multi
    def jsonify(
        self, parser, date_formatter=_format_date, datetime_formatter=_format_datetime
    ):
            ...
            for field in parser:
                ...
                if subparser:
                    if field_type in ("one2many", "many2many"):
                        res[json_key] = rec[field_name].jsonify(
                            subparser,
                    ...
                    if value is False and field_type != "boolean":
                        ...
                        value = date_formatter(rec, value)
                    elif field_type == "datetime":
                        value = datetime_formatter(rec, value)
                    res[json_key] = value
            result.append(res)
        return result
