...
[base_video_link](base_video_link/) | 14.0.1.0.1 |  | Add the possibility to link video on record
...
[upgrade_analysis](upgrade_analysis/) | 14.0.2.1.1 |  | Performs a difference analysis between modules installed on two different Odoo instances
