...
[base_sequence_default](base_sequence_default/) | 14.0.0.1.0 | [![Shide](https://github.com/Shide.png?size=30px)](https://github.com/Shide) | Use sequences for default values of fields when creating a new record
