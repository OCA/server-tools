...
[base_exception](base_exception/) | 10.0.3.0.1 | This module provide an abstract model to manage customizable exceptions to be applied on different models (sale order, invoice, ...)
