...
[module_auto_update](module_auto_update/) | 8.0.2.0.2 | Automatically update Odoo modules
...
[password_security](password_security/) | 8.0.1.1.1 | Allow admin to set password security requirements.
