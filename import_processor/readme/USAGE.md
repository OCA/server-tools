...
Settings \> Technical \> Import Processors. It offers 3 different kind
of snippets depending on the import stage:
...
After configuration every user can use the processors Favorites \>
Import Processor on the specified models.
