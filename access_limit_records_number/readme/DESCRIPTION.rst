...
For example, you can restrict number of vehicles in fleet_vehicle, say by three.
...
And also there is new model base.limit.records_number to store the settings.
...
This project is based on this other project: https://apps.odoo.com/apps/modules/11.0/access_limit_records_number/