...
odoo.define('red_october.WidgetPasswordGet', function (require) {
    "use strict";
    ...
    var WidgetPasswordGet = Widget.extend({

        template: 'red_october.WidgetPasswordGet',
