...
from odoo.addons.dbfilter_from_header.hooks import db_filter
...
class TestDbfilterFromHeader(common.BaseCase):
    ...
    def test_db_filter(self):
        ...
        with patch.object(odoo.service.db, "list_dbs", list_dbs):
            ...
            filtered_dbs = odoo.addons.dbfilter_from_header.hooks.db_filter(
    ...
    def test_function_is_monkey_patched(self):
        ...
        self.assertEqual(odoo.http._is_monkey_patch_filtered, True)
        self.assertEqual(
            inspect.getsource(odoo.http.db_filter),
            inspect.getsource(odoo.addons.dbfilter_from_header.hooks.db_filter),
        )
