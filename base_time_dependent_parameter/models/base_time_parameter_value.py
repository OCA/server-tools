...
class HrSalaryRuleParameterValue(models.Model):
    ...
    time_parameter_id = fields.Many2one("base.time_parameter", required=True, ondelete="cascade", string=(_("Time Parameter")))
    ...
    parameter_value = fields.Text(help=(_("Python Code")))
