...
class MailMessage(models.Model):
    ...
    def _get_autovacuum_domain(self, rule):
        ...
        limit_date = fields.datetime.strptime(
            today, DEFAULT_SERVER_DATETIME_FORMAT
        ) - timedelta(days=rule.retention_time)
        domain += [("date", "<", limit_date.strftime(DEFAULT_SERVER_DATETIME_FORMAT))]
