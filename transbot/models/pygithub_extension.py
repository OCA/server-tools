try:
    ...
    github = None
    github.GithubObject.NotSet = None
...
def put_file_contents(self, path, message, content, sha=None,
    ...
    assert ref is github.GithubObject.NotSet or isinstance(ref,
                                                           (str, unicode)), ref
...
def delete_file(self, path, message, sha, ref=github.GithubObject.NotSet):
    """
