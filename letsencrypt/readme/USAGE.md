...
`_respond_challenge_dns_$DNS_PROVIDER` where `$DNS_PROVIDER` is the name
of your provider and can be any string with length greater than zero,
and add the name of your DNS provider in the settings dns_provider
selection field.
