...
class NonTransactionalCase(TransactionCase):
    ...
    def test_overload_before_drop(self):
        ...
        self.demo_matview_mdl.drop_materialized_view_if_exist(cr, uid,
        ...
        self.assertEqual(
            self.mat_view_mdl.read(
                cr, uid, ids, ['state'], context=self.context)[0]['state'],
            u'aborted')
        self.demo_matview_mdl.create_or_upgrade_pg_matview_if_needs(cr, uid, context=self.context)
    ...
    def test_overload_before_create(self):
        ...
        self.demo_matview_mdl.create_materialized_view(cr, uid, context=self.context)
