...
4. If needed, override the defaults using the following system parameters:
...
5. The configuration parameters are applied to tables by the daily cron job.
	...
	```
6. Monitor vacuum activity and table bloat, then adjust the settings if your
	workload changes.
